---
title: Nested subgraph with own checkpointer has writes stored under wrong namespace (regression in 1.2.3)
...
- bug
- external
contributor: ranerev7
discovered_at: '2026-06-10'
verified: false
---

- [Nested subgraph with own checkpointer has writes stored under wrong namespace (regression in 1.2.3)](https://github.com/langchain-ai/langgraph/issues/8038) — github:langchain-ai/langgraph
