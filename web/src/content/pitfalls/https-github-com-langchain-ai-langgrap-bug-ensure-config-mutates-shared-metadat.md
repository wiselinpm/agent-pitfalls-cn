---
title: "bug: ensure_config mutates shared metadata when copiable keys passed by reference"
...
references:
- title: 'bug: ensure_config mutates shared metadata when copiable keys passed by reference'
  url: https://github.com/langchain-ai/langgraph/issues/7441
...
- [bug: ensure_config mutates shared metadata when copiable keys passed by reference](https://github.com/langchain-ai/langgraph/issues/7441) — github:langchain-ai/langgraph
