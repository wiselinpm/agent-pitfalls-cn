---
title: create_react_agent aborts return_direct=True tools with "need more steps" when remaining_steps == 1
...
- bug
- external
contributor: adarshprabhu03
discovered_at: '2026-06-27'
verified: false
---

- [create_react_agent aborts return_direct=True tools with "need more steps" when remaining_steps == 1](https://github.com/langchain-ai/langgraph/issues/8204) — github:langchain-ai/langgraph
