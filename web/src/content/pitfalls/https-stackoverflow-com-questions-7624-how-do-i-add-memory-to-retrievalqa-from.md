...
- title: How do i add memory to RetrievalQA.from_chain_type? or, how do I add a custom prompt to ConversationalRetrievalChain?
  url: https://stackoverflow.com/questions/76240871/how-do-i-add-memory-to-retrievalqa-from-chain-type-or-how-do-i-add-a-custom-pr
  source: so:q:langchain
tags:
- python
- openai-api
- chatgpt-api
- langchain
- py-langchain
contributor: Hudson Etkin
discovered_at: '2023-05-13'
verified: false
---

- [How do i add memory to RetrievalQA.from_chain_type? or, how do I add a custom prompt to ConversationalRetrievalChain?](https://stackoverflow.com/questions/76240871/how-do-i-add-memory-to-retrievalqa-from-chain-type-or-how-do-i-add-a-custom-pr) — so:q:langchain
