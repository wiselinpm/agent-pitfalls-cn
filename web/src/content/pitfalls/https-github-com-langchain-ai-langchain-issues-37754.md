...
- title: 'Bug: Inflated Token Usage Reporting for accounts/fireworks/models/qwen3p6-plus with reasoning_effort="none"'
  url: https://github.com/langchain-ai/langchain/issues/37754
...
- [Bug: Inflated Token Usage Reporting for accounts/fireworks/models/qwen3p6-plus with reasoning_effort="none"](https://github.com/langchain-ai/langchain/issues/37754) — github:langchain-ai/langchain
