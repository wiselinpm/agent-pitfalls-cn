---
title: StateGraph silently drops node output keys not declared in TypedDict
...
- bug
- external
contributor: harshitayadavv
discovered_at: '2026-07-10'
verified: false
---

- [StateGraph silently drops node output keys not declared in TypedDict](https://github.com/langchain-ai/langgraph/issues/8320) — github:langchain-ai/langgraph
