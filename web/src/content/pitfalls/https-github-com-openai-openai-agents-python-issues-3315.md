...
### Please read this first - **Have you read the docs?** Yes. This concerns structured output schema generation. - **Have you searched for related issues?** Yes. No related issue or PR was found. ### Describe the bug `AgentOutputSchema(dict[str, int], strict_json_schema=False)
