...
fixes: []
references:
- title: '[BUG] Cowork: all tasks fail with retry loop then ECONNRESET — fails across networks incl. phone hotspot, survived clean reinstall, worked hours earlier same day (macOS 15.7.3, M3)'
  url: https://github.com/anthropics/claude-code/issues/68092
...
- area:cowork
- area:networking
contributor: IbanezNunez
discovered_at: '2026-06-12'
verified: false
---

- [[BUG] Cowork: all tasks fail with retry loop then ECONNRESET — fails across networks incl. phone hotspot, survived clean reinstall, worked hours earlier same day (macOS 15.7.3, M3)](https://github.com/anthropics/claude-code/issues/68092) — github:anthropics/claude-code
