...
## Preflight Checklist - [x] I have searched existing issues and this hasn't been reported (only adjacent/different bugs exist — see References) - [x] This is a single bug report - [x] I am using the latest version of Claude Code ## What's Wrong? When `AskUserQuestion` is invo
